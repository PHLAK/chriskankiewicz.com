<footer>
    <div class="bg-gray-100 px-4 py-8 sm:px-6">
        <div class="container flex justify-center space-x-4 sm:space-x-6 mx-auto">
            <a href="https://github.com/PHLAK" title="GitHub" class="text-github transition-all hover:scale-125">
            ...
            <a href="https://keybase.io/chriskankiewicz" title="Keybase" class="text-keybase transition-all hover:scale-125">
                <i class="fab fa-keybase fa-fw fa-2x"></i>
            </a>

            <a href="https://steamcommunity.com/id/phlak" title="Steam" class="text-steam transition-all hover:scale-125">
